...
\c posts;
-- creación de tabla
CREATE TABLE posts (id SERIAL PRIMARY KEY, nombre_usuario VARCHAR(30) NOT NULL, fecha_creacion DATE NOT NULL, contenido VARCHAR(300) NOT NULL, descripcion VARCHAR(100) NOT NULL);
-- insertar datos
INSERT INTO posts (nombre_usuario, fecha_creacion, contenido, descripcion) VALUES ('Pamela', '2022-04-05', 'Hola mundo', 'Mi primer post, aprendiendo a usar PostgreSQL');
